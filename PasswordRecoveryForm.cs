...
namespace pract8
{
    public partial class PasswordRecoveryForm : Form
    {
        ...
        {
            MailAddress from = new MailAddress("kirill.ignat.ev@yandex.ru", "Кирилл");
            ...
            {
                Credentials = new NetworkCredential("kirill.ignat.ev@yandex.ru", "rcnzchhvcxbjxjbp"), // Убедитесь, что пароль защищен
                EnableSsl = true,
            };
